...
export const problems: Problem[] = [
  ...
  { id: 5, problema: "Processos administrativos sem padronização", regional: "São Paulo", escola: "FATEC São Paulo", eixo: "Gestão e processos", evidencia: "67% dos processos sem fluxo definido", metaSmart: "67% → 20% até set/2026", status: "warning", totalAcoes: 4, acoesAtrasadas: 1 },
  { id: 6, problema: "Evasão em cursos noturnos", regional: "Campinas", escola: "FATEC Campinas", eixo: "Permanência e sucesso do aluno", evidencia: "Evasão de 22% no noturno", metaSmart: "22% → 12% até dez/2026", status: "critical", totalAcoes: 5, acoesAtrasadas: 3 },
  { id: 7, problema: "Ausência de formação continuada docente", regional: "Sorocaba", escola: "FATEC Sorocaba", eixo: "Qualidade pedagógica", evidencia: "40% dos docentes sem capacitação no ano", metaSmart: "40% → 10% até jun/2026", status: "warning", totalAcoes: 3, acoesAtrasadas: 0 },
  ...
  { id: 15, problema: "Abandono em estágio obrigatório", regional: "São Paulo", escola: "FATEC São Paulo", eixo: "Permanência e sucesso do aluno", evidencia: "15% de desistência no estágio", metaSmart: "15% → 5% até dez/2026", status: "warning", totalAcoes: 4, acoesAtrasadas: 1 },
  { id: 16, problema: "Wifi instável nos blocos de aula", regional: "Campinas", escola: "FATEC Campinas", eixo: "Infraestrutura", evidencia: "60% dos alunos reportam instabilidade", metaSmart: "60% → 10% até mar/2026", status: "critical", totalAcoes: 2, acoesAtrasadas: 1 },
  { id: 17, problema: "Falta de material didático atualizado", regional: "Sorocaba", escola: "FATEC Sorocaba", eixo: "Qualidade pedagógica", evidencia: "35% dos materiais com mais de 5 anos", metaSmart: "35% → 5% até jun/2026", status: "warning", totalAcoes: 3, acoesAtrasadas: 0 },
  ...
  { id: 22, problema: "Baixa taxa de conclusão no prazo", regional: "Campinas", escola: "FATEC Campinas", eixo: "Permanência e sucesso do aluno", evidencia: "Apenas 55% concluem no prazo regular", metaSmart: "55% → 80% até dez/2026", status: "critical", totalAcoes: 5, acoesAtrasadas: 3 },
