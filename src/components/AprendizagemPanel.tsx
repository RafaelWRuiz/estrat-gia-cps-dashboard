...
const learnings: Learning[] = [
  ...
  { titulo: "Necessidade de reforço administrativo em duas unidades", descricao: "Sobrecarga da equipe administrativa resultou em atrasos na emissão de documentos e falhas no controle de frequência.", impacto: "Prazo médio: 5 → 15 dias", tipo: "atencao", escola: "ETEC Bento Quirino / ETEC Cons. Antônio Prado", regional: "Campinas" },
