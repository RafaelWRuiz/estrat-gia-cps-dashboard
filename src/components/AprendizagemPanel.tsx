...
const learnings: Learning[] = [
  ...
  { titulo: "Capacitação docente em metodologias ativas elevou engajamento", descricao: "Oficinas de aprendizagem baseada em projetos aumentaram a participação ativa dos alunos em sala.", impacto: "Engajamento: +35%", tipo: "positivo", escola: "ETEC Botucatu", regional: "Sorocaba" },
  { titulo: "Parceria com empresa local gerou estágios", descricao: "Convênio firmado com indústria da região abriu 40 vagas de estágio para alunos do curso técnico.", impacto: "40 vagas abertas", tipo: "positivo", escola: "ETEC Polivalente", regional: "Campinas" },
